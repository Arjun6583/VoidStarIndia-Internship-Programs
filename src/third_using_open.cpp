...
int main(int argc, char *args[]) 
{
  ...
  bool valid_paths = check_platform_file_path(source_file_path, destination_file_path);
  if (!valid_paths) 
  {
  ...
  bool result = copy_file_using_open(source_file_path, destination_file_path);
  if (result)
  {
